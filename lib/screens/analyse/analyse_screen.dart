...
class _AnalyseScreenState extends State<AnalyseScreen> {
  ...
  void initState() {
    super.initState();
    _nameController    = TextEditingController(text: _mockResult['name']);
    _kcalController    = TextEditingController(text: _mockResult['kcal'].toString());
    _proteinController = TextEditingController(text: _mockResult['protein'].toString());
    _carbsController   = TextEditingController(text: _mockResult['carbs'].toString());
    _fatController     = TextEditingController(text: _mockResult['fat'].toString());
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildFeatureTile(Icons.camera_alt_outlined, 'Scan your meal for an instant calorie estimate'),
          const SizedBox(height: 8),
          _buildFeatureTile(Icons.qr_code_scanner_outlined, 'Scan any nutrition label to log exact macros'),
          const SizedBox(height: 8),
          _buildFeatureTile(Icons.edit_outlined, 'Review and edit results before they\'re logged'),
        ],
      ),
    );
  }
